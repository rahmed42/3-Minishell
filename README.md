...
- Wildcards * should work for the current working directory.
 ...
 ### useful pour comprendre bash :

https://unix.stackexchange.com/questions/159513/what-are-the-shells-control-and-redirection-operators

https://hackernoon.com/u/MIMA

https://en.wikipedia.org/wiki/Lexical_analysis

http://www.linusakesson.net/programming/tty/

### Ressources pratique pour minishell :
 0 http://i.paysdu42.fr/?page=minishell.c
...
Pour l'Abstract Syntax Tree :

 1 https://tomassetti.me/guide-parsing-algorithms-terminology/

 2 https://pastebin.com/K1YZchMK

 3 https://files.gogaz.org/42sh-appsinges.html

 4 https://ruslanspivak.com/lsbasi-part1/

 5 https://ruslanspivak.com/lsbasi-part2/

 6 https://ruslanspivak.com/lsbasi-part3/

 7 https://ruslanspivak.com/lsbasi-part4/

 8 https://ruslanspivak.com/lsbasi-part5/

 9 https://ruslanspivak.com/lsbasi-part6/

 10 https://ruslanspivak.com/lsbasi-part7/
...
### Précisions :
- Il y a des algos efficaces pour faire le parsing :
[Lexical Analysis](https://en.wikipedia.org/wiki/Lexical_analysis)

(voir le projet de @mkayumba : [explication de son projet](https://github.com/maxime-42/minishell/tree/master/tutorials))

#### Tuto venant de maxime42 que j'ai trouvé très utile :
